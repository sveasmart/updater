...
class ProgressBar {
   ...
   *
   */
  constructor(display, row = 0, text = "") {
    ...
    //text [========]
    this.maxBarCount = 16 - (text.length + 3) //+3 takes into account the space and two brackets
  ...
  _drawProgressBarOnDisplay() {
    ...
    this.display.writeText(content, 0, this.row, false)
  }
}
